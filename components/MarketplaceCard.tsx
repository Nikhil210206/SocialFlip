...
export default function MarketplaceCard({ listing, index }: MarketplaceCardProps) {
  ...
  return (
    ...
    >
      {/* Featured Ribbon */}
      {listing.featured && (
        <div className="gradient-featured py-1.5 px-4 flex items-center justify-center">
      ...
      <div className="p-4 sm:p-5 flex flex-col gap-3 flex-1">
        ...
        <div className="flex items-center justify-between pt-1 mt-auto">
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.96 }}
            className="gradient-purple text-white text-xs sm:text-sm font-semibold px-4 sm:px-5 py-2 sm:py-2.5 rounded-xl hover:shadow-md hover:shadow-purple-200 transition-all duration-200 whitespace-nowrap"
          >
            More Details
          </motion.button>
        </div>
