...
export default function MarketplacePage() {
  ...
  const filteredListings = useMemo(() => {
    return mockListings.filter((listing) => {
      ...
      // Platform filter
      if (filters.platforms.length > 0 && !filters.platforms.includes(listing.platform as Platform)) {
        return false;
      }
            ...
            {filteredListings.length > 0 ? (
              ...
              >
                ...
                <button
                  ...
                  className="gradient-purple text-white px-5 py-2.5 rounded-xl text-sm font-semibold hover:opacity-90 transition-opacity"
                >
                  Clear all filters
                </button>
              </motion.div>
