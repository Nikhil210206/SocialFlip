    ...
    <nav className="bg-white border-b border-gray-200">
      <div className="max-w-6xl mx-auto px-6 h-[72px] flex items-center justify-between">
        ...
        <ul className="hidden md:flex items-center gap-10 text-[15px] text-gray-600">
          ...
          <li className="cursor-pointer transition hover:text-indigo-600">
            <a href="http://localhost:3000/marketplace">Marketplace</a>
          </li>

          <li className="cursor-pointer transition hover:text-indigo-600">
            <a href="http://localhost:5175">Messages</a>
          </li>

          <li className="font-semibold text-gray-900 cursor-pointer hover:text-indigo-600">
            <a href="http://localhost:5177">Dashboard</a>
          </li>
