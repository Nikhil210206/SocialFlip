...
function ListingCard({ id, title, handle, followers, engagement, tag, country, description, price, featured, iconBg, iconSrc }) {
    return (
        <div className="relative flex flex-col w-full max-w-[342px] lg:max-w-[672px] bg-[#FFFFFF] border border-[#F3F4F6] rounded-[16px] shadow-[0px_1px_3px_rgba(0,0,0,0.1),0px_1px_2px_-1px_rgba(0,0,0,0.1)] overflow-hidden">
            ...
            <div className={`flex flex-col px-[20.8px] pb-[20.8px] ${featured ? 'pt-[20.8px]' : 'pt-[34.8px]'}`}>
                ...
                <div className="flex items-center justify-between mt-[24px] lg:mt-[46px]">
                    ...
                    <Link to={`/marketplace/${id}`} className="flex items-center justify-center w-[136px] h-[44px] bg-[#4F39F6] rounded-[8px] text-[#FFFFFF] font-['Rethink_Sans'] font-normal text-[14px] leading-[20px] hover:bg-[#3D1DFF] transition-colors">
                        More Details
                    </Link>
                </div>
            </div>
    ...
    return (
        <section className="flex flex-col items-center pt-24">
            ...
            <div className="relative flex lg:w-[448px] w-[380px] items-center justify-center pt-4">
                ...
                />
                <Link to="/marketplace" className="absolute right-[5px] font-['Rethink Sans'] font-[14px] font-light text-[#FFFFFF] flex items-center justify-center h-[44px] w-[92px] bg-[#4F39F6] rounded-[6px] hover:bg-[#3D1DFF] transition-colors">
                    Search
                </Link>
            </div>
                    ...
                    <div className="flex flex-col relative w-[343px] lg:w-[328px] h-[384px] rounded-[12px] overflow-hidden shadow-sm" style={{ background: 'linear-gradient(0deg, rgba(0, 0, 0, 0.03), rgba(0, 0, 0, 0.03)), #FFFFFF' }}>
                        ...
                        <div className="flex flex-col px-[16px] justify-center h-[63px] border-t-[0.8px] border-black/11 bg-[#FFFFFF]">
                            <button
                                ...
                                className="relative w-full h-[30px] bg-[#4F46E5] rounded-[6px] shadow-[0px_0px_0px_1px_#4F46E5,0px_2px_3px_rgba(34,42,53,0.2),0px_1px_1px_rgba(0,0,0,0.24),inset_0px_1px_1px_rgba(255,255,255,0.07)] overflow-hidden flex items-center justify-center cursor-pointer"
                            >
            ...
            <div className="flex justify-center mt-[64px] border-[1px] rounded-[8px] bg-gradient-to-r from-[rgba(152,16,250,0.2)] to-[rgba(43,127,255,0.3)] px-[4px] w-[396px] h-[296px] lg:w-[1024px] lg:h-[365px] mx-auto">
                <div className="flex flex-col mt-[49px] lg:mt-[65px] items-center">
                    ...
                    <div className="flex mt-[18px]">
                        <Link to="/marketplace" className="flex items-center justify-center font-['Rethink_Sans'] font-normal text-[14px] text-center text-[#ffffff] w-[156px] h-[40px] bg-gradient-to-r from-[#9810FA] to-[#2B7FFF] rounded-[12px] hover:opacity-80 transition-opacity">
                            Get Started Today
                        </Link>
                    </div>
                </div>
            ...
            {(subscribed || trialStarted) && (
                <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-[1000] flex items-center justify-center p-4">
                    <div className="bg-white rounded-2xl p-6 sm:p-8 max-w-sm w-full text-center border border-gray-100 shadow-xl animate-fadeIn">
                        ...
                        <h3 className="text-xl font-bold text-gray-900 mb-2">
                            {subscribed ? "Subscription Activated!" : "7-Day Free Trial Started!"}
                        </h3>
                        <p className="text-sm text-gray-500 mb-6">
                            {subscribed 
                                ? "Thank you for subscribing! Your Premium features have been unlocked." 
                                : "Welcome to SocialFlip Premium! Your 7-day free trial is now active."}
                        </p>
                        <button
                            onClick={() => { setSubscribed(false); setTrialStarted(false); }}
                            className="w-full bg-[#4F39F6] hover:bg-[#3D1DFF] text-white font-semibold py-3 rounded-xl transition cursor-pointer"
                        >
                            Awesome, Thanks!
                        </button>
                    </div>
