...
export default function Navbar() {
  ...
  const navLinks = [
    { href: "http://localhost:5173", label: "Home" },
    { href: "/marketplace", label: "Marketplace" },
    { href: "http://localhost:5175", label: "Messages" },
    { href: "http://localhost:5177", label: "Dashboard" },
    { href: "http://localhost:5174", label: "Wallet" },
    { href: "http://localhost:3001", label: "Sell" },
  ];
